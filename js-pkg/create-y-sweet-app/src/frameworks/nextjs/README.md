This is a [Y-Sweet](https://jamsocket.com/y-sweet) project using [Next.js](https://nextjs.org). It was bootstrapped with [`@y-sweet/create-y-sweet-app`](https://www.npmjs.com/package/@y-sweet/create-y-sweet-app).
