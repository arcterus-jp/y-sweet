This is a [Y-Sweet](https://jamsocket.com/y-sweet) project using [Remix](https://remix.run). It was bootstrapped with [`@arcterus-jp/create-y-sweet-app`](https://www.npmjs.com/package/@arcterus-jp/create-y-sweet-app).
